...
public class FileService {
    ...
    public void method4(){
        ...
        //  /io_test/practice/files 폴더 내에 method4.txt  를 생성하는 경로 구분들
        System.out.println("/io_test/practice/files" + "/method4.txt");
    ...
    public void method5(){
        // File 객체 생성
        // C:\Users\tj\Desktop\frontend_yh\01_수업 폴더\java-workspace 경로 확인 잘하기
        // 오류 : java.lang.NullPointerException: Cannot read the array length because "<local3>" is null
        File directory = new File("/Users/tj/Desktop/frontend_yh/01_수업 폴더/java-workspace/java_basic");
        ...
        for(File file : files){
            ...
            /**
             * .git                 2025-09-08 14:29     폴더
             * files                2025-09-08 13:27     폴더
             * java_basic.iml       2025-08-25 10:43     파일           433B
             * src                  2025-09-08 14:29     폴더
             */
        }
    }
}
