...
public class Nation {
    ...
    */
    /* 
    * 메서드 생성자 기본 필수 생성
    * 필수 생성자의 경우 필드 속성값에 작성되어있는 변수 명칭 순서대로 작성
    * */
    ...
    * setJuminNumber 메서드 이름처럼 회색 빛으로
    ...
    * name, age, gender는 외부에서 변수이름을 직접적으로 호출해서 사용불가
    * public coid introduce() 메서드 내부에서 변수이름을 호출하고
