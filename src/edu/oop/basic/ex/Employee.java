...
public class Employee {
    ...
    * 근무 년수 3년 이상 승진 가능
    * checkPromotion if
    * oo님은 근무년수 oo년으로 승진 대상자입니다.
    * (3년 이하일 경우) oo님은 근무년수 oo년으로 승진까지 oo년 더 필요로 합니다.
    * */
    /*
    * 캡슐화 원칙대로 수행
    * System.out.printf("%s님은 근무년수 %d년으로 승진 대상자입니다.\n", getName(), getWorkYears());
    * System.out.printf("%s님은 근무년수 %d년으로 승진 대상자입니다.\n", name, workYears);
    * 추후에는 속성만 작성해놓은 클래스와 속성을 활용한 기능을 작성해놓은 클래스
    * 속성과 기능을 활용해서 실행하는 클래스 나뉨
    *
    * 위에 작성한 System 구문이 모두 가능하지만 추후 미래를 위하여 get변수이름() 형식으로 작성하는 습관을 가지고 있는 것이 좋음
    * */
