...
public class GoogleService {
    // private은 해당 클래스 내에서만 접근가능, 자식클래스에서 접근 불가능!
    ...
    // 상속은 "확장"의 개념이므로, 자식 클래스가 부모의 속성을 자유롭게 사용할 수 있도록 protected 사용함
    // 상속에서는 protected 많이 사용됨
    ...
    // 공통으로 변경없이 사용할 메서드
    public void login(){
        System.out.println(userName + "님이 " + serviceName + "에서 로그인했습니다.");
    }

    public void logout(){
        System.out.println(userName + "님이 " + serviceName + "에서 로그아웃했습니다.");
    }
    ...
    public void share(){
        System.out.println(serviceName + "에서 rhdfb합니다.");
    }
