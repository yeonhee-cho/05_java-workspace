...
// 상속 키워드 extends (확장하다)
// -> 부모의 코드를 자식이 물려받아 자식의 전체 크기가 증가(코드가 증가한다는 의미)
public class 개발자 extends 직원 {
    ...
    public 개발자(String eName, int eId, double baseSalary, String department, String computer) {
        ...
        /**
         * this 대신 super를 이용해서
         * 매개변수로 전달받은 eName, eId, baseSalary, department를 사용하겠다 처리
         * this.eName = eName;
         * this.eId = eId;
         * this.baseSalary = baseSalary;
         * this.department = department;
         */
        this.computer = computer; // this. 를 여러번 작성할 필요 없이 직원클래스에 1번만 작성하고
    ...
    public void info() {
        ...
        public void info(){
            ...
            // eName을 직접적으로 사용하기 보다는 get활용해서 작성
