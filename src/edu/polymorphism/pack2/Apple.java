 ...
 * extends 부모클래스이름 적어주기
 *
 * ab Fruit에 적어준 후 오류:
 * 클래스 'Apple'은(는) abstract로 선언되거나 'Fruit'에서 추상 메서드 'taste()'을(를) 구현해야 합니다
 *
 * Fruit 부모 클래스에 작성된
 * public abstract void taste();를
 * Apple 자식 클래스에서 자식 클래스 형식에 맞게 기능을 수정하여 작성하지 않아서 발생하는 문제
 *
 * 그런데
 *
 ...
 *
 * abstract = 가 붙은 기능은 자식 클래스에서 자식 클래스에 맞게 다시 작성해야함을 표기
 */
public class Apple extends Fruit {
    ...
    public void taste() {
        ...
        // oo 품종의 사과의 맛은 알 수 없습니다.
        // 사과의 맛은 oo 품종에 따라 다릅니다.
    }
    
    // info 메서드는 abstract가 붙지 않아 필수로 자식클래스에서 자식클래스에 맞게 재설정하지 않아도 됨
}
