...
public class 일반Member extends Member {
    // 자식 클래스에서 부모 클래스에 작성된 필드만 사용하고, 
    // 자식 클래스는 필드를 작성하지 않은 채 메서드만 재정의를 할 수 있음
    ...
    // Member 클래스에서 필수로 재정의 하라고 했던 기능이기 때문에 반드시 생성
    @Override
    public double 할인율() {
        return 0.05; // 일반 멤버는 5% 할인
    }

    @Override
    public void 쿠폰과혜택() {
        System.out.println("보유하고 있는 쿠폰과 혜택이 존재하지 않습니다.");
        System.out.println("구독서비스에 따라 쿠폰과 혜택을 받으실 수 있습니다.");
    }
}
