...
public class CustomExceptionService {
    ...
    public void problem1() {
        ...
        try {
            ...
            if(height <= 0){
                throw new NegativeNumberException("키는 0 이하로는 적을 수 없습니다.");
            }
    ...
    public void problem2() {
        ...
        try {
            ...
            if(password.length() < 6){
                throw new TooShortPasswordException("비밀번호는 6자 이상 적어주세요.");
            }
    ...
    public void problem3() {
        ...
        try {
            ...
            if(score < 0 || score > 100){
                throw new InvalidScoreException("0 ~ 100 범위로 작성해주세요.");
            }
    ...
    public void problem4() {
        ...
        try {
            ...
            if(name.trim().isEmpty()){
                throw new EmptyNameException("이름이 비어있거나 공백입니다. 올바른 이름을 작성해주세요.");
            }
    ...
    public void problem5() {
        ...
        try {
            ...
            if(itemCount > 10){
                throw new TooManyItemsException("상품 개수는 10개 이하로 작성해주세요.");
            }
