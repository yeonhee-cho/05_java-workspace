 ...
 * 기능을 중지하는 상황을 만들어줘야함
 * 
 * 프로그램에서 원하는 상황으로 진행할 수 있도록 개발자가 프로그램 흐름을 한 번 더 설정
 */
public class ExceptionPractice2 {
    ...
    public void problem1() {
        ...
        try {
            ...
            // 나이를 입력받아서 0보다 작거나 150보다 크면 throw new 를 작성해서 나이는 0 ~ 150 이상이어야 합니다.
    ...
    public void problem2() {
        ...
        try {
            ...
            if (password.length() < 8) {
                throw new RuntimeException("비밀번호를 8자 이상 입력하세요.");
            }
    ...
    public void problem3() {
        ...
        try {
            ...
            if(score < 0 || score > 100){
                throw new IllegalArgumentException("점수는 0~100 사이어야 합니다.");
            }
