...
public class ArrayEx1 {
    ...
    *
    * 참조현 변수란?
    * 개발자가 만들어 놓은 클래스 파일을 참조하는 변수 이름
    * */
    ...
    * */
    public void method1(){
        ...
        // 배열 할당
        arr = new int[4];
        // Heap 영역에 int 4개 짜리 배열을 할당 후
        // 생성된 배열의 주소를 "arr"변수에 대입

        // -> arr을 이용해서 배열을 참조해서 arr에 지정된 데이터를 사용할 수 있음

        // 배열 초기화
        // 1) 초기화 전 -> 0 이 대입되어 있는지 확인
        System.out.println("초기화 전 배열의 상태");
        System.out.println("arr가 위치한 컴퓨터 내의 주소 명칭, 칸의 위치 : " + arr);
        ...
        /**
         * arr[4] = 5555; // 문제 발생
         * 나오는 오류 : Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: Index 4 out of bounds for length 4
         * 초기화 전 배열의 상태
         * arr의 초기값 : [I@2f4d3709
         * arr의 초기값의 길이 : 4
         * at edu.array.ArrayEx1.method1(ArrayEx1.java:59)
         ...
         *
         * 추후 ArrayList로 자바스크립트처럼 최초로 지정한 칸 수와 관계없이 데이터를 추가할 수 있는 class 파일을
         * 자바 개발자사 만든 후 자바 버전을 업그레이드 하였고,
         * 개발자들은 ArrayList와 같은 기능을 활용해서 유연하게 데이터를 추가하고 삭제할 수 있음
        */
        System.out.println("초기화 후");
        System.out.println("arr의 초기화 후 값 : " + arr);
        ...
        /*
        * 디버그 모드
        * - 확인하고 싶은 코드 다음 줄에 break point 추가해서 문제 확인할 것!
        * */
    }
    ...
    * */
    public void method2(){
        ...
        // index는 length -1 한 값
        // index 0번 부터 length -1 번까지만 추가할 것
