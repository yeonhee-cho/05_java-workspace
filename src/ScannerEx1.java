...
public class ScannerEx1 {
    public static void main(String[] args) {
        ...
        *
        * 외부 라이브러리 > (자바버전폴더) > java.base > java > util > Scanner 존재
        *
        ...
        * */
        ...
        // * System.in : 인텔리제이 실행창이나 CLI(cmd = 명령프롬포트) 창에서 키보드로 입력
        ...
        * 하지만 자바에서는 각 변수마다 메모리 할당량을 측정하기 위해서 
        * 변수 이름 내부에 넣어줄 값의 종류가 무엇인지 결정해주고,
        * 종류에 해당하는 값만 작성을 해야함
        * 
        ...
        * */
        ...
        // 공백 처리를 위해 sc.nextLine();을 사용해서 공백담아내는 기능 설정
        ...
        * */
        ...
        // System.out.println("num에 들어 있는 숫자 : ",  num);
        System.out.println("num에 들어 있는 숫자 : " +  num1);
